...
export default function Footer() {
  ...
  return (
    <footer className="bg-soft-surface w-full border-t border-border-subtle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-xxl">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="inline-block mb-lg">
              <img src="/Clean_Backround.png" alt="Onea Africa" className="h-10 w-auto" />
            </Link>
            ...
            <div className="flex gap-sm">
              <a href="https://www.facebook.com/ONEAAI" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-on-surface-variant hover:bg-[#1877F2] hover:text-white transition-all shadow-sm border border-border-subtle">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://twitter.com/ONEA_AFRICA" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-on-surface-variant hover:bg-[#000000] hover:text-white transition-all shadow-sm border border-border-subtle">
              ...
              <a href="https://www.instagram.com/onea_af" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-on-surface-variant hover:bg-[#E4405F] hover:text-white transition-all shadow-sm border border-border-subtle">
              ...
              <a href="https://www.linkedin.com/company/onea-africa" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-on-surface-variant hover:bg-[#0A66C2] hover:text-white transition-all shadow-sm border border-border-subtle">
