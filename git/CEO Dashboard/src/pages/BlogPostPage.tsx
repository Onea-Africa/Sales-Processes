        ...
        <div className="max-w-[800px] mx-auto px-xl">
          ...
          <div className="mt-xxl pt-xl border-t border-border-subtle">
            ...
            <div className="flex gap-sm">
              ...
              <a href={`https://wa.me/?text=${encodeURIComponent(`${post.title} — https://onea.africa/blog/${post.id}`)}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-soft-surface flex items-center justify-center text-on-surface-variant hover:bg-[#25D366] hover:text-white transition-all border border-border-subtle" aria-label="Share on WhatsApp">
